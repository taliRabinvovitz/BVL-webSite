...
using KollelSite.Helpers;

namespace KollelSite
{
    public class MultiLanguageEngine : RazorViewEngine
    {
        private static string _currentCulture = GlobalHelper.CurrentCulture;

        public MultiLanguageEngine(): this(GlobalHelper.CurrentCulture){
        }

        public MultiLanguageEngine(string lang)
        {
